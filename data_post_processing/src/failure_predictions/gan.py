    ...
    def train(self, data_path, pattern, epochs,batch_size=128, sample_interval=100, output_path = None):
        ...
        for file in training_files:
            ...
            for point in data:
                ...
                X_heatmaps.append((point[:,:,1]/255.0 - 0.5))
...
if __name__ == "__main__":
    ...
    g = GAN()
    validation_files = g.train(sys.argv[1],'failure_rate_training_data.npz', epochs=20000, batch_size = 32, sample_interval = 500, output_path = output_folder)
