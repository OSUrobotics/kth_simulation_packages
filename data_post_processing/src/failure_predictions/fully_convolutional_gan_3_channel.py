...
class GAN:
    ...
    def train(self, data_path, pattern, epochs,batch_size=32, sample_interval=100, output_path = None):
        ...
        for file in training_files:
            ...
            # data = data['arr_0']
            # for point in data:
            X_maps.append((data[:,:,0]/255.0 - 0.5))
            X_paths.append((data[:,:,1]/255.0 - 0.5))
            X_heatmaps.append((data[:,:,2]/255.0 - 0.5))
        ...
        for epoch in range(epochs):
            ...
            if epoch % sample_interval == 0:
                self.sample_images(epoch,X_maps,X_paths, X_heatmaps,output_path)
...
if __name__ == "__main__":
    ...
    g = GAN()
    validation_files = g.train(sys.argv[1],'fully_convolutional_paths_data.npy', epochs=50000, batch_size=8, sample_interval = 500, output_path = output_folder)
